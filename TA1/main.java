...
public class main {
    ...
    private static HashMap<String, Driveble> generateLotMap() {
        ...
        Car kiaPicanto2 = new Car("Kia", "Picanto", "409-94-301", 959, 173, 5);
        ...
        System.out.println(kiaPicanto == kiaPicanto2);

        int x = 5;
        int y = 5;
        System.out.println(x == y);
        System.out.println(kiaPicanto.equals(kiaPicanto2));
//        System.out.println(mitsubishSpaceStar.equals(kiaPicanto));
//        System.out.println("sfd");
//        System.out.println(kiaPicanto2.equals(kiaPicanto));
            System.out.println(kiaPicanto2 instanceof MotorVehicle);
